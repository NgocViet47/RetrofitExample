...
public class SharedPreference {
    private static final String DATA_NAME_SHARED_PREFERENCES = "myDataSharedPreferences";
    ...
    public static void saveString(String mString,String key, Context context){
        SharedPreferences sharedPreferences = context.getSharedPreferences(DATA_NAME_SHARED_PREFERENCES, MODE_PRIVATE);
